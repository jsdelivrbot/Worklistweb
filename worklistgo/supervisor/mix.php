    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function atualizamix() {//ajustado para a nova estrutura de supervisao
                    var industria = $("#selectIndus").val();
                    var cliente = $("#selectCliente").val();
                    var rca = $("#select_rca").val();
                    
                    if(rca==1){
                    $.post('classes/sql_mix.php', {industriaselecionada: industria, cliente: cliente,rca:rca}, function (data) {
                        $("#preenchermix").empty();
                ...
                function atualizaMixClientes() {//ajustado para a nova estrutura de supervisao
                    var industria = $("#selectIndus").val();
                    var cliente = $("#selectCliente").val();
                    var rca = $("#select_rca").val();
                    if (cliente != 1) {
                        ...
                        $("#mixcli").show();
                        $.post('classes/sql_mix_clientes.php', {industriaselecionada: industria, cliente: cliente,rca:rca}, function (data) {
                ...
                function atualizaMixIndustrias() {//ajustado para a nova estrutura de supervisao
                    var industria = $("#selectIndus").val();
                    var cliente = $("#selectCliente").val();
                    var rca = $("#select_rca").val();
                    if (industria != 1) {
                        ...
                        $("#mixindus").show();
                        $.post('classes/sql_mix_industrias.php', {industriaselecionada: industria, cliente: cliente,rca:rca}, function (data) {
                ...
                function salvaPlanilha1() {
                    var htmlPlanilha = "<table>" + document.getElementById("mixprodutos").innerHTML + "</table>";
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <select class="select_rca js-example-responsive" id="select_rca">
                                            <option value="1">TODOS OS REPRESENTANTES</option>
                                            <?php
...
" ORDER BY razao_social ";
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <span class="legenda_indus"></span>
                                        <select class="js-example-responsive" id="selectIndus">
                                            <option value="1">TODAS AS INDUSTRIAS</option>
                                            <?php
                                            require_once 'classes/bd.php';
                                            $bd = new bd();
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="mixprodutos" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador" >
