        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function salvaPlanilha() {
                    var htmlPlanilha = "<table>" + document.getElementById("cmvcli").innerHTML + "</table>";
                ...
                function atualizaCMV() {
                    var industriaselecionada = $("#select_indus").val();
                    $.post('classes/sql_cmv.php', {industriaselecionada: industriaselecionada}, function (data) {
                        $("#cmv").empty();
                        $("#cmv").html(data);
                    })
                }
                ...
                function atualizaCMV_Dia() {
                    var industriaselecionada = $("#select_indus").val();
                    $.post('classes/sql_cmv_dia.php', {industriaselecionada: industriaselecionada}, function (data) {
                        $("#cmv_dia").empty();
                        $("#cmv_dia").html(data);
                    })
                }
                    ...
                    <div class="row"> <!-- Inicio row framework -->
                        <div class="col-xl-7 col-lg-9 col-md-12 col-sm-12 "> <!-- Inicio coluna framework -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <select class="js-example-responsive" id="select_indus">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <table class="table table-bordered dataTable no-footer" id="cmvcli" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador">
