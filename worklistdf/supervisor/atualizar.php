    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function enviarrequisicao() {//ajustado para a nova estrutura de supervisao
                    var rca = $(".select_rca").val();
                    $.post('classes/sql_atualizar.php', {rca: rca}, function (data) {
                        $("#preencherrequisicao").empty();
                        $("#preencherrequisicao").html(data);
                    })
                }

                function retornorequisicao() {//ajustado para a nova estrutura de supervisao
                    var rca = $(".select_rca").val();
                    $.post('classes/sql_atualizar_retorno.php', {rca: rca}, function (data) {
                        $("#preencherretorno").empty();
                        $("#preencherretorno").html(data);
                    })
                }

                function recuperasenha() {//ajustado para a nova estrutura de supervisao
                    var rca = $(".select_rca").val();
                    $.post('classes/sql_recuperasenha.php', {rca: rca}, function (data) {
                        $("#PreencherRepresentante").empty();
                        $("#PreencherRepresentante").html(data);
                    })
                }
            })
        </script>
...
ORDER BY a.apelido";
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador" >
                                                    ...
                                                    <th align="center">Solicitacao    </th>
                                ...
                                <div class="card-body">
                                    <div class='container'>
                                        <div class='row'>
                                            ...
                                            <div align="center" class='col-4' >
                                                <a  class="btn btn-sm  formatbtn" id="btnretorno">
                                                    <span class="fa fa-refresh" ></span>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                    <i class="fa fa-key"></i> Recuperar Senhas
                                </div>
                                <div class="card-body">
                                    <div class='container'>
                                        <div class='row'>
                                            ...
                                            <div align="center" class='col-4' >
                                                <a  class="btn btn-sm  formatbtn" id="btnrecupera">
                                                    <span class="fa fa-refresh" ></span>
                                                </a>
                                            </div>
                                        </div>
                                    ...
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            <tbody id="PreencherRepresentante">
