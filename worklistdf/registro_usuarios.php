                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" name="equipe" id="equipe">
                                        <option value="sul">Equipe Sul</option>
                                        <option value="norte">Equipe Norte</option>
                                        <option value="hertz">Equipe Hertz</option>
                                        <option value="baby">Equipe Baby</option>
                                        <option value="hpc">Equipe HPC</option>
                                        <option value="fitness">Equipe Fitness</option>
                                        <option value="gerencia">Equipe Gerencia</option>
                                    </select>
                                </div>
