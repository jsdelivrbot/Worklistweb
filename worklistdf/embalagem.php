...
<html lang="pt">
    ...
    <head>
        ...
        <title>Embalagem - DF Distribuidora</title>
        <!-- Bootstrap core CSS-->
    ...
    $(document).ready(function(){
        $("#pesquisaprod").keyup(function(){
            var barra=$("#pesquisaprod").val();
            $.post('classes/sql_embalagem.php', {barra: barra},function(data){
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <input type="text" id="pesquisaprod" placeholder="Pesquisar Produto"style="width: 300px; margin-top: 10px;">
