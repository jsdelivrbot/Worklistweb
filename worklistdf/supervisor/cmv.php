        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function salvaPlanilha2() {
                    var htmlPlanilha = "<table>" + document.getElementById("cmvindus").innerHTML + "</table>";
                    var htmlBase64 = btoa(htmlPlanilha);
                    var link = "data:application/vnd.ms-excel;base64," + htmlBase64;
...
ORDER BY a.apelido";
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <table class="table table-bordered dataTable no-footer" id="cmvindus" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador">
