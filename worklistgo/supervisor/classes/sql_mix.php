...
if ($industriaselecionada == 1) {
  $query .= " and a.idindustria IN(select distinct idindustria from sys_vendas a,"
          . "sys_acessos b where a.idvendedor =  b.idrepresentante and "
...
FROM
sys_vendas a, sys_acessos b WHERE a.idvendedor = b.idrepresentante ";
...
$query .="GROUP BY A.idvendedor, b.nome" ; 
...
$percmes1 = number_format((($row['mes1'] / $mix )*100), 0, ',', '.');
$percmes2 = number_format((($row['mes2'] / $mix )*100), 0, ',', '.');
$percmes3 = number_format((($row['mes3'] / $mix )*100), 0, ',', '.');
$percmes4 = number_format((($row['mes4'] / $mix )*100), 0, ',', '.');
$percmes5 = number_format((($row['mes5'] / $mix )*100), 0, ',', '.');
$percperiodo = number_format((($periodo / $mix )*100), 0, ',', '.');
        
 echo "<tr>";
echo '<td rowspan="2" align="center" style="font-weight:bold; color:#295ba6"> ' . $row['nome']. '</td>';
echo '<td rowspan="2" align="center" style="font-weight:bold; color:#295ba6"> ' . $mix. '</td>';
echo '<td align="center" style="font-weight:bold;"> ' . $row['mes5'] . '</td>';
echo '<td align="center" style="font-weight:bold;"> ' . $row['mes4'] . '</td>';
echo '<td align="center" style="font-weight:bold;"> ' . $row['mes3'] . '</td>';
echo '<td align="center" style="font-weight:bold;"> ' . $row['mes2'] . '</td>';
echo '<td align="center" style="font-weight:bold;"> ' . $row['mes1'] . '</td>';
echo '<td align="center" style="font-weight:bold; color:#295ba6"> ' . $row['periodo'] . '</td>';
echo "</tr>";  
