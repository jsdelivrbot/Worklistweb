        ...
        <div class="container">
            <div class="card card-login mx-auto mt-5">
                <div class="card-header" id="banner-login">
                    <img class="banner_pg_inicial" src="img/worklist_login.svg" alt="" >
                </div>
                ...
                <div class="card-body">
                    <form action="classes/acesso_banco.php" method="post">
                        ...
                        <button class="btn btn-md btn-primary btn-block btn-signin" type="submit">Logar</button>
                    </form>
                    <div class="text-center">
                        <a class="d-block small mt-3" href="registro_usuarios.php">Registrar Usuário</a>
