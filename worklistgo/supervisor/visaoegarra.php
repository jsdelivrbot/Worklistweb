...
<html lang="pt">
    ...
    <script>
        $(document).ready(function () {
            ...
            function atualizaPainelDanone() {//ajustado para a nova estrutura de supervisao
                var mes = $("#select_mes").val();
                var iddocliente = $(".select_cliente").val();
                var rca = $(".select_rca").val();
                $.post('classes/sql_danone.php', {mes: mes, idcliente: iddocliente, rca: rca}, function (data) {
                    $("#paineldanone").empty();
                    $("#paineldanone").html(data);
                })
            }

            function atualizaCobertura() {//ajustado para a nova estrutura de supervisao
                var mes = $("#select_mes").val();
                var iddocliente = $(".select_cliente").val();
                var rca = $(".select_rca").val();
                $.post('classes/sql_coberturamultipladanone.php', {mes: mes, idcliente: iddocliente, rca: rca}, function (data) {
                    $("#coberturamultipla").empty();
                    $("#coberturamultipla").html(data);
                })

            }
            function atualizaDn() {//ajustado para a nova estrutura de supervisao
                var mes = $("#select_mes").val();
                var iddocliente = $(".select_cliente").val();
                var rca = $(".select_rca").val();
                $.post('classes/dn.php', {mes: mes, idcliente: iddocliente, rca: rca}, function (data) {
                    // $("#paineldn").empty();
                    $("#paineldn").html(data);
                })
            }
            function atualizaposgrupo() {//ajustado para a nova estrutura de supervisao
                var mes = $("#select_mes").val();
                var iddocliente = $(".select_cliente").val();
                var rca = $(".select_rca").val();
                $.post('classes/sql_positivacaogrupo.php', {mes: mes, idcliente: iddocliente, rca: rca}, function (data) {
                    $("#positivacaogrupo").html(data);
                })
            }

            function blacklist() {//ajustado para a nova estrutura de supervisao
                var mes = $("#select_mes").val();
                var iddocliente = $(".select_cliente").val();
                var rca = $(".select_rca").val();
                $.post('classes/sql_blacklist.php', {mes: mes, idcliente: iddocliente, rca: rca}, function (data) {
                    if (data == 0) {
                        $("#blacklistatu").hide();
                    } else {
                        $("#blacklistatu").show();
            ...
            function atualizaSellout() {
                ...
                var iddocliente = $(".select_cliente").val();
                var rca = $(".select_rca").val();
                $.post('classes/sql_sellout.php', {industriaselecionada2: industria2, idcliente: iddocliente, rca: rca}, function (data) {
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <select class="js-example-responsive" id="select_mes" style="width: 27%; color: #185752; font-weight: bold;">
                                            <?php atualizaMeses(); ?>
                                        </select>                                   
    ...
    a.idcli = c.idcli and
    b.idrepresentante in (select idrca from sys_supervisao where idsupervisor = " . $_SESSION['idrepresentante'] . " order by idrca) order by c.razao_social";
...
ORDER BY a.apelido";
                            ...
                            <div class="card mb-3" id="selloutcliente">
                                <div class="card-header">
