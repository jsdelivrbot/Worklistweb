...
if ($industriaselecionada = 1) {
  $query .= " and a.idindustria IN(select distinct idindustria from sys_vendas a,sys_acessos b where a.idvendedor =  b.idrepresentante and a.idvendedor in (select idrca from sys_supervisao where idsupervisor = ".$_SESSION['idrepresentante']." order by idrca)) ";
} else{
