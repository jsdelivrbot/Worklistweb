        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function salvaPlanilha() {
                    var htmlPlanilha = "<table>" + document.getElementById("historico").innerHTML + "</table>";
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <select class="js-example-responsive" id="inputpreencher" style="width: 29%; margin-left:1%;">
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="historico" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador">
                                                    <!--<th>Codigo</th>-->
                            ...
                            <div class="modal" id="janela">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <i class="fa fa-file-excel-o" id="exportar2"></i></div>
                                    </div> 
                                </div>
                            </div>
