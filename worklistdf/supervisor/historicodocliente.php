        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function salvaPlanilha1() {
                    var htmlPlanilha = "<table>" + document.getElementById("historicocli").innerHTML + "</table>";
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="historicocli" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador">
                                                    <!--<th>Codigo</th>-->
