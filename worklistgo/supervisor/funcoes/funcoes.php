...
function defineCorCliPositivado($valor) {
    if ($valor <= 0) {
        ...
        echo "<td style='color:#185752; vertical-align:middle; text-align:center; font-weight: bold;'>$valor</td>";
    }
}
...
function defineCorCliPositivadoDAN($valor) {
    if ($valor <= 0) {
        ...
        echo "<td style='color:#185752; vertical-align:middle; font-weight: bold;'>$valor</td>";
    }
}
...
function CorPedidos($valor){
    if ($valor <= 0) {
        ...
        echo "<td style='color:#185752; vertical-align:middle; text-align:center; font-weight: bold;'>R$ ".number_format($valor, 2, ',', '.')."</td>";
    }
}
