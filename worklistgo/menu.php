...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top " id="mainNav">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="potencial">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="mix">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="inadimplencia">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="right" title="visaoegarra">
           ...
           <li class="nav-item" data-toggle="tooltip" data-placement="right" title="atualizar">
