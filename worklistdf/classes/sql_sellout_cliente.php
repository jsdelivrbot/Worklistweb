...
<script>
    $(document).ready(function () {
        ...
        function salvaPlanilha2() {
            var htmlPlanilha = "<table>" + document.getElementById("tableProd").innerHTML + "</table>";
        ...
        $('.btn_detalhar').click(function () {
            ...
            $.post('classes/sql_modalprodutos.php', {industria: idindustria, cliente: iddocliente}, function (data) {
                $("#vendaproduto").empty();
