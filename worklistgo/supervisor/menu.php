    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Components">
          ...
          <ul class="sidenav-second-level collapse" id="collapseComponents">
           <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Metas">
               <a class="nav-link" href="montarequipes.php" >
                    <i class="fa fa-fw fa-users"></i>
                    <span class="nav-link-text">Criar Equipes</span>
                </a>
            </li>
           <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Metas">
               <a class="nav-link" href="import_objcmv.php" >
                    <i class="fa fa-fw fa-users"></i>
                    <span class="nav-link-text">Importar Objetivos CMV</span>
                </a>
            </li>
           <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Metas">
