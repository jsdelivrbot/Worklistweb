    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                function atualizaInadCidade() {//ajustado para a nova estrutura de supervisao
                    var idcli = $("#selectCliente").val();
                ...
                function atualizaInadClientes() {//ajustado para a nova estrutura de supervisao
                    var idcli = $("#selectCliente").val();
                    var rca = $(".select_rca").val();
                ...
                function atualizaInadDetalhada() {//ajustado para a nova estrutura de supervisao
                    var idcli = $("#selectCliente").val();
                    var rca = $(".select_rca").val();
                ...
                function salvaPlanilha1() {
                    var htmlPlanilha = "<table>" + document.getElementById("inadgeral").innerHTML + "</table>";
...
ORDER BY a.apelido";
    ...
    b.idrepresentante in (select idrca from sys_supervisao where idsupervisor = " . $_SESSION['idrepresentante'] . " order by idrca) ";
                            ...
                            <div class="card mb-3" id="inad_cidade">
                                <div class="card-header">
                                    <i class="fa fa-table"></i> Inadimplência Geral
                                    <i class="fa fa-file-excel-o" id="exportar1"></i>
                                </div>
                                <div class="card-body">
                                    <div  class="table-responsive dataTables_wrapper form-inline dt-bootstrap no-footer">
                                        <table class="table table-bordered dataTable no-footer" id="inadgeral" width="100%" cellspacing="0">
                                            <thead>
                                                <tr class="cabecalho_indicador">
                                                    <th style="width: 40%;
                                                        ">Representante</th>
