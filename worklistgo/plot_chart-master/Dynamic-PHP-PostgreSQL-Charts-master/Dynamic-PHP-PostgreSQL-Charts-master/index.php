...
<?php
	...
	$host= "host=187.72.34.18";
	// add values for below variables according to your system
	$port= "port=5432";
	$dbname="dbname=worklist";
	$dbuser="user=df";
	$dbpwd="password=tidf123";
...
<?php
  ...
  $result = pg_query($dbconn, "SELECT razaosocial as country_name, idindustria as medals FROM SYS_INDUSTRIAS; ") or exit("Error with quering database");
