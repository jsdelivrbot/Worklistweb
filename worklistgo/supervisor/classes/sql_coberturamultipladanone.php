...
if (pg_affected_rows($sql_cm_geral) == 0) {
    ...
    while ($valores = pg_fetch_array($sql_cm_geral)) {
        ...
        if (round($valores['apt1'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['apt1'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['apt2'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['apt2'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['apt3'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['apt3'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['aptar'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['aptar'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['aptac'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['aptac'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['pro1'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['pro1'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['gum'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['gum'], 2) . "'></i></td>";
            $cm++;
        }
        /*
          if ($cm == 7) {
