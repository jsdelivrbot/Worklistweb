...
if (pg_affected_rows($sql_cm_geral) == 0) {
    ...
    while ($valores = pg_fetch_array($sql_cm_geral)) {
        ...
        if (round($valores['imf'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['imf'], 2) . "'></i></td>";
            $cm++;
        }
        ...
        if (round($valores['profutura'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['profutura'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['cereal'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['cereal'], 2) . "'></i></td>";
            $cm++;
        }
        if (round($valores['sustain'], 2) <= 0) {
            ...
            echo "<td style='vertical-align:middle; text-align:center;'><i class='fa fa-fw fa-thumbs-o-up' style='color:#185752;' title='R$ " . round($valores['sustain'], 2) . "'></i></td>";
            $cm++;
        }
