                                        ...
                                        <table class="table table-bordered dataTable no-footer" id="dataTable" width="100%" cellspacing="0" style="text-align: center;">
                                            <thead>
                                                <tr class="cabecalho_indicador">
                                                    <th style="width: 33%;">Carteira</th>
                                                    <th style="width: 33%;">Vencido</th>
                                                    <th style="width: 33%;">%Inadimplência</th>
                                                </tr>
                                            </thead>
...
while ($row_inadcli = pg_fetch_array($result_inadcli)) {
    ...
    echo '<td width=70 style="color:red;font-weight:bold;">R$ ' . number_format($row_inadcli['inadimplencia'], 0, ',', '.') . '</td>';
    echo "</tr>";
}
?>
                                            </tbody>                               
