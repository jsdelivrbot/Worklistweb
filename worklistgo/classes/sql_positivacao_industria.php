...
while ($row = pg_fetch_array($result)) {
    ...
    switch ($row['fq']) {
        case 0: echo '<td width=15 align=center> ' . $nivel0 . '</td>';
            break;
        case 1: echo '<td width=15 align=center> ' . $nivel1 . '</td>';
            break;
        case 2: echo '<td width=15 align=center> ' . $nivel2 . '</td>';
            break;
        case 3: echo '<td width=15 align=center> ' . $nivel3 . '</td>';
            break;
    }
